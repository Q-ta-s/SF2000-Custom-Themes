...
SET QS_HYPER_LIST_VALUE=0 88 640 392

SET QS_DEF_SCREEN_VALUE=44 118 144 208
...
SET QS_RET=
FOR /F "delims=" %%I IN ('CMD /U /C ECHO;–¼') DO (
  SET CR=%%I
  SET CR=!CR:~0,1!
)
...
FOR /F "usebackq delims=" %%A IN ("%QS_SD_DRIVE%\Resources\%QS_FOLDER_NAM_INI%") DO (
  ...
  SET QS_RET=!QS_RET!!QS_LINE_BUF!!CR!!LF!
)
...
<NUL SET /P "=!QS_RET!"> "%QS_SD_DRIVE%\Resources\%QS_FOLDER_NAM_INI%"
